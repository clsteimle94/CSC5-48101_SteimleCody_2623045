/* 
   ...
   Purpose:  Weather generation and output statistics.
 */
...
int main(int argc, char** argv) {
    ...
    //Initialize
    cout<<"This program will generate the weather, and provide the stats."<<endl; 
...
void fillAry(char weather[][NUMDAYS],int nMonths){
    ...
    for(int days=0;days<NUMDAYS;days++){
        for(int months=0;months<nMonths;months++){
            weather[months][days]=type[rand()%3];   //Fills days with a random weather.
        }
    }
}

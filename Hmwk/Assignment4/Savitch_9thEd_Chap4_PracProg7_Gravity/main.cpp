...
int main(int argc, char** argv) {
    ...
    float msOne=6.0f;     //Mass of Mark -> Slug
    float msTwo=6371.0f; //Google radius of the earth km
    float weight;          //Force of attraction from Physics
    
    //Conversion of inputs
    cout<<"Enter the weight of the first object:"<<endl;
    cin>>msOne;
    cout<<"Enter the weight of the second object:"<<endl;     
    cin>>msTwo;

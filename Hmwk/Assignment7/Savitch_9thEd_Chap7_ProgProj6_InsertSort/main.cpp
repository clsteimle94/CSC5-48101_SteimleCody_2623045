...
void inSort (int [],int [],int);  //Insert Sort
...
//Fill array for to-be-sorted
//Initialize empty sorted array
//Take the first element and put it in sorted[0]]
//Take to-be-sorted[1] and compare it to sorted[0] to place it before or after
